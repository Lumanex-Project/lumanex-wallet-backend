...
export declare class SubWallets {
     ...
     */
    getSpendableTransactionInputs(subWalletsToTakeFrom: string[], currentHeight: number): TxInputAndOwner[];
     ...
     */
    getTransactions(address?: string, includeFusions?: boolean): Transaction[];
    /**
     ...
     * has changed.
     */
    getNumTransactions(address?: string, includeFusions?: boolean): number;
    /**
     ...
     */
    getUnconfirmedTransactions(address?: string, includeFusions?: boolean): Transaction[];
    /**
     ...
     * has changed.
     */
    getNumUnconfirmedTransactions(address?: string, includeFusions?: boolean): number;
