 ...
 * @hidden
 */
export declare function validateAmount(destinations: Array<[string, number]>, fee: FeeType, subWalletsToTakeFrom: string[], subWallets: SubWallets, currentHeight: number, config?: IConfig): WalletError;
/**
