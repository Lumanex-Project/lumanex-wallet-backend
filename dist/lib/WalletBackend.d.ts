...
import { Block, Transaction, TransactionInput, DaemonConnection, SendTransactionResult, PreparedTransaction } from './Types';
...
export declare class WalletBackend extends EventEmitter {
     ...
     */
    sendFusionTransactionAdvanced(mixin?: number, subWalletsToTakeFrom?: string[], destination?: string): Promise<SendTransactionResult>;
    /**
     ...
     *                              Defaults to false.
     */
    sendTransactionAdvanced(destinations: Array<[string, number]>, mixin?: number, fee?: FeeType, paymentID?: string, subWalletsToTakeFrom?: string[], changeAddress?: string, relayToNetwork?: boolean, sendAll?: boolean): Promise<SendTransactionResult>;
    /**
     ...
     */
    getNumTransactions(subWallet?: string, includeFusions?: boolean): number;
