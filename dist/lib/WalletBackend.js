...
class WalletBackend extends events_1.EventEmitter {
    ...
    sendFusionTransactionAdvanced(mixin, subWalletsToTakeFrom, destination) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.sendTransactionInternal(() => {
                return Transfer_1.sendFusionTransactionAdvanced(this.config, this.daemon, this.subWallets, mixin, subWalletsToTakeFrom, destination);
            }, true, true);
        });
    }
    /**
     ...
     *                              Defaults to false.
     */
    sendTransactionAdvanced(destinations, mixin, fee, paymentID, subWalletsToTakeFrom, changeAddress, relayToNetwork, sendAll) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.sendTransactionInternal(() => {
                return Transfer_1.sendTransactionAdvanced(this.config, this.daemon, this.subWallets, destinations, mixin, fee, paymentID, subWalletsToTakeFrom, changeAddress, relayToNetwork, sendAll);
